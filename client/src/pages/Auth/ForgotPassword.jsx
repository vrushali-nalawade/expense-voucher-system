    ...
    <div className="max-w-md w-full bg-white p-8 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50 space-y-6">
      ...
      {step === 1 ? (
        ...
        <form onSubmit={handleConfirmReset} className="space-y-4">
          <div className="space-y-1.5">
            <label className="block text-xs font-semibold uppercase text-slate-600">
              Verification Code / Token <span className="text-rose-500">*</span>
            </label>
            <input
              type="text"
              value={resetToken}
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 text-xs font-semibold text-slate-500 hover:text-slate-800 transition-colors pt-2"
      >
